...
class OutputReport(styles.FontColor):
    def __init__(self):
        ...
        self.Expected_success_cases = list(map(lambda x: 'Pass', range(0, 5)))
    ...
    def output_report(self):
        ...
        self.ws.write(6, self.impact_use_case_col, 'Create Bulk Impact', self.style8)
        ...
        if impact_result[4]['Test Case'] == 'create_bulk_impact':
