...
class OutputReport(styles.FontColor):
    def __init__(self):
        ...
        self.Expected_success_cases = list(map(lambda x: 'Pass', range(0, 6)))
    ...
    def output_report(self):
        ...
        self.ws.write(7, self.impact_use_case_col, 'Create Bulk Impact', self.style8)
        ...
        if impact_result[5]['Test Case'] == 'create_bulk_impact':
